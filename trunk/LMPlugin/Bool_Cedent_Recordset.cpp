...
{
	return _T("[taTask],[tdCedentD],[tdEquivalenceClass],[tdLiteralD],[tmAttribute],[tmMatrix],[tmQuantity],[tsCedentType],[tsCoefficientType],[tsGaceType],[tsLiteralType],[tsTaskSubType]");
}
...
void Bool_Cedent_Recordset::DoFieldExchange(CFieldExchange* pFX)
{
	...
	RFX_Long(pFX, _T("[tdEquivalenceClass].[EquivalenceClassID]"), m_EquivalenceClassID);
	RFX_Text(pFX, _T("[tdEquivalenceClass].[Name]"), m_Name3);
	RFX_Long(pFX, _T("[tdEquivalenceClass].[CedentDID]"), m_CedentDID2);
	RFX_Text(pFX, _T("[tdEquivalenceClass].[Notice]"), m_Notice3);
	RFX_Long(pFX, _T("[LiteralDID]"), m_LiteralDID);
	RFX_Long(pFX, _T("[tdLiteralD].[CedentDID]"), m_CedentDID3);
	...
	RFX_Long(pFX, _T("[tdLiteralD].[EquivalenceClassID]"), m_EquivalenceClassID2);
	...
	RFX_Text(pFX, _T("[tdLiteralD].[Notice]"), m_Notice4);
	RFX_Long(pFX, _T("[tmAttribute].[AttributeID]"), m_AttributeID);
	RFX_Text(pFX, _T("[tmAttribute].[Name]"), m_Name4);
