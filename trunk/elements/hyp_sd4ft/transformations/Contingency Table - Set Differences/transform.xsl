			...
			<xsl:element name="table" >
				...
				<tr id="{$id_base}r1">
					...
					<td id="{$id_base}r1d3" bgcolor="{$border_color}" border_top="{$bord_out}"  border_right="{$bord_in}" border_bottom="{$bord_frm}">
						<text id="{$id_base}r1d3text"><xsl:value-of select="$AntecedentLabel"/> &amp; ¬ <xsl:value-of select="$SuccedentLabel"/></text> 
					</td>
					<td id="{$id_base}r1d4" bgcolor="{$border_color}" border_top="{$bord_out}"  border_right="{$bord_in}" border_bottom="{$bord_frm}">
						<text id="{$id_base}r1d4text">¬ <xsl:value-of select="$AntecedentLabel"/> &amp; <xsl:value-of select="$SuccedentLabel"/></text> 
					</td>
