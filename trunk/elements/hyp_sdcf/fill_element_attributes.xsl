				...
				<xsl:when test="$lng='cz'">    
						<xsl:choose>
							...
							<xsl:when test="name()='avg_a1'">
								<xsl:text>Aritmetický průměr kardinálních hodnot 1</xsl:text>
							</xsl:when>
							
							<xsl:when test="name()='avg_g1'">
								<xsl:text>Geometrický průměr kardinálních hodnot 1</xsl:text>
							</xsl:when>
							...
							<xsl:when test="name()='avg_a2'">
								<xsl:text>Aritmetický průměr kardinálních hodnot 2</xsl:text>
							</xsl:when>
							
							<xsl:when test="name()='avg_g2'">
								<xsl:text>Geometrický průměr kardinálních hodnot 2</xsl:text>
							</xsl:when>
