...
Control11=IDC_ADD_ATTR_LINK_TABLE_BUTTON,button,1342242816
Control12=IDC_CONFIGURE_ATTR_LINK_TABLE_BUTTON,button,1342242816
...
Column24=[LiteralDID], 4, 4
Column25=[tdLiteralD].[CedentDID], 4, 4
Column26=[tdLiteralD].[QuantityID], 4, 4
Column27=[CategoryID], 4, 4
Column28=[tdLiteralD].[LiteralTypeID], 4, 4
Column29=[tdLiteralD].[GaceTypeID], 4, 4
Column30=[EquivalenceClassID], 4, 4
Column31=[tdLiteralD].[CoefficientTypeID], 4, 4
Column32=[tdLiteralD].[MinLen], 4, 4
Column33=[tdLiteralD].[MaxLen], 4, 4
Column34=[tdLiteralD].[Ord], 4, 4
Column35=[tdLiteralD].[Notice], 12, 510
Column36=[tmAttribute].[AttributeID], 4, 4
Column37=[tmAttribute].[Name], 12, 100
Column38=[tmAttribute].[MatrixID], 4, 4
Column39=[AttributeSubTypeID], 4, 4
Column40=[ValueSubTypeID], 4, 4
Column41=[Derived], -7, 1
Column42=[Formula], 12, 510
Column43=[MCPosition], 4, 4
Column44=[MCLength], 4, 4
Column45=[MCDelimiter], 12, 510
Column46=[PrimaryKeyPosition], 4, 4
Column47=[ValueMin], 8, 8
Column48=[ValueMax], 8, 8
Column49=[ValueAvg], 8, 8
Column50=[ValueModus], 8, 8
Column51=[ValueVariability], 8, 8
Column52=[tmAttribute].[Notice], 12, 510
Column53=[tmAttribute].[wSavedCountUsed], 4, 4
Column54=[tmMatrix].[MatrixID], 4, 4
Column55=[tmMatrix].[Name], 12, 100
Column56=[Initialised], -7, 1
Column57=[RecordCount], 4, 4
Column58=[tmMatrix].[Notice], 12, 510
Column59=[tmMatrix].[wSavedCountUsed], 4, 4
Column60=[tmQuantity].[QuantityID], 4, 4
Column61=[tmQuantity].[Name], 12, 100
Column62=[tmQuantity].[ShortName], 12, 510
Column63=[ShowName], -7, 1
Column64=[tmQuantity].[AttributeID], 4, 4
Column65=[ItemShift], 4, 4
Column66=[ParentGroupID], 4, 4
Column67=[tmQuantity].[wSavedCountUsed], 4, 4
Column68=[wUpdateVer], 4, 4
Column69=[tmQuantity].[UserID], 4, 4
Column70=[tmQuantity].[Notice], 12, 510
Column71=[tsCedentType].[CedentTypeID], 4, 4
Column72=[tsCedentType].[Name], 12, 100
Column73=[tsCedentType].[ShortName], 12, 40
Column74=[tsCedentType].[Ord], 4, 4
Column75=[tsCedentType].[Notice], 12, 510
Column76=[tsCoefficientType].[CoefficientTypeID], 4, 4
Column77=[tsCoefficientType].[Name], 12, 100
Column78=[tsCoefficientType].[ShortName], 12, 40
Column79=[tsCoefficientType].[Ord], 4, 4
Column80=[tsCoefficientType].[Notice], 12, 510
Column81=[tsGaceType].[GaceTypeID], 4, 4
Column82=[tsGaceType].[Name], 12, 100
Column83=[tsGaceType].[ShortName], 12, 40
Column84=[tsGaceType].[Ord], 4, 4
Column85=[tsGaceType].[Notice], 12, 510
Column86=[tsLiteralType].[LiteralTypeID], 4, 4
Column87=[tsLiteralType].[Name], 12, 100
Column88=[tsLiteralType].[ShortName], 12, 40
Column89=[tsLiteralType].[Ord], 4, 4
Column90=[tsLiteralType].[Notice], 12, 510
Column91=[tsTaskSubType].[TaskSubTypeID], 4, 4
Column92=[tsTaskSubType].[Name], 12, 100
Column93=[tsTaskSubType].[ShortName], 12, 40
Column94=[tsTaskSubType].[Ord], 4, 4
Column95=[tsTaskSubType].[Notice], 12, 510
...
DBType=ODBC
ColumnCount=4
Column1=[EquivalenceClassID], 4, 4
Column2=[Name], 12, 100
