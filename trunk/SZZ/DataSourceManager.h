...
#ifndef _DATA_SOURCE_MANAGER
#define _DATA_SOURCE_MANAGER
...
*/	
	...
	//predbezne:
	BSTR CallPerformProc(int source_index, char* element_id); //vrati XML string
